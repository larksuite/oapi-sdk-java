...
public class TestReqTranslator {
    ...
    public void testTranslator() throws Exception {
        ...
        Object httpReq = reqTranslator.translate(body, AccessTokenType.Tenant, config, "POST", "https://open.feishu.cn/open-apis/im/v1/messages?receive_id_type=open_id", options);
        assert httpReq != null;
