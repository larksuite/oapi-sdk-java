...
public class GetTableRecordListAppTableSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        GetTableRecordListAppTableReq req = GetTableRecordListAppTableReq.newBuilder()
        ...
        // 发起请求
        GetTableRecordListAppTableResp resp = client.spark().v1().appTable().getTableRecordList(req);
