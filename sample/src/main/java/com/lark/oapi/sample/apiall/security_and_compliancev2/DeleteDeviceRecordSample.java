...
public class DeleteDeviceRecordSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        DeleteDeviceRecordReq req = DeleteDeviceRecordReq.newBuilder()
                .deviceRecordId("7089353870308032531")
                .build();

        // 发起请求
        DeleteDeviceRecordResp resp = client.securityAndCompliance().v2().deviceRecord().delete(req);
