...
// POST /open-apis/directory/v1/employees
    ...
    public static void main(String arg[]) throws Exception {
        ...
        CreateEmployeeReq req = CreateEmployeeReq.newBuilder()
                ...
                .createEmployeeReqBody(CreateEmployeeReqBody.newBuilder()
                        .employee(CreateEmployee.newBuilder().build())
                        .options(CreateEmployeeOptions.newBuilder().build())
                        .build())
                .build();

        // 发起请求
        CreateEmployeeResp resp = client.directory().v1().employee().create(req);
