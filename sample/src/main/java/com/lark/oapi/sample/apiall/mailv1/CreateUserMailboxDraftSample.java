...
public class CreateUserMailboxDraftSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        CreateUserMailboxDraftReq req = CreateUserMailboxDraftReq.newBuilder()
                .userMailboxId("aba@aac.com 或 me")
                .createUserMailboxDraftReqBody(CreateUserMailboxDraftReqBody.newBuilder()
        ...
        // 发起请求
        CreateUserMailboxDraftResp resp = client.mail().v1().userMailboxDraft().create(req);
