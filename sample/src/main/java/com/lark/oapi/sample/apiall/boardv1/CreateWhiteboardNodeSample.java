...
public class CreateWhiteboardNodeSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        CreateWhiteboardNodeReq req = CreateWhiteboardNodeReq.newBuilder()
        ...
        // 发起请求
        CreateWhiteboardNodeResp resp = client.board().v1().whiteboardNode().create(req);
