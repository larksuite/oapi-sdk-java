...
public class GetEnumListAppEnumSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        GetEnumListAppEnumReq req = GetEnumListAppEnumReq.newBuilder()
        ...
        // 发起请求
        GetEnumListAppEnumResp resp = client.spark().v1().appEnum().getEnumList(req);
