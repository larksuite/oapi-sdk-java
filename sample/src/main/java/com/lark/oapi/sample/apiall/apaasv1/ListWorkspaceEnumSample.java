...
public class ListWorkspaceEnumSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        ListWorkspaceEnumReq req = ListWorkspaceEnumReq.newBuilder()
        ...
        // 发起请求
        ListWorkspaceEnumResp resp = client.apaas().v1().workspaceEnum().list(req);
