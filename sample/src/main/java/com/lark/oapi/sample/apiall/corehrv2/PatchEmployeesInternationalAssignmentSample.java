...
// PATCH /open-apis/corehr/v2/employees/international_assignments/:international_assignment_id
public class PatchEmployeesInternationalAssignmentSample {
    ...
    public static void main(String arg[]) throws Exception {
        ...
        // 创建请求对象
        PatchEmployeesInternationalAssignmentReq req = PatchEmployeesInternationalAssignmentReq.newBuilder()
        ...
        // 发起请求
        PatchEmployeesInternationalAssignmentResp resp = client.corehr().v2().employeesInternationalAssignment().patch(req);
